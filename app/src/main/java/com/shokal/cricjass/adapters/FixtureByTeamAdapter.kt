...
import com.shokal.cricjass.fragments.team.TeamDetailsWithFixturesFragmentDirections
import com.shokal.cricjass.models.fixtures.Data
import com.shokal.cricjass.models.fixtures.Run
import com.shokal.cricjass.viewmodels.CricketViewModel
import com.squareup.picasso.Picasso
import java.util.*

@Suppress("DEPRECATION")
class FixtureByTeamAdapter(
    private val context: Context, private val viewModel: CricketViewModel, val list: List<Data>
) : RecyclerView.Adapter<FixtureByTeamAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.cardItem.setOnClickListener {
            val action =
                TeamDetailsWithFixturesFragmentDirections.actionTeamDetailsWithFixturesFragmentToFixtureDetailsFragment(
                    fixture
                )
