package com.shokal.cricjass.viewmodels
...
import com.shokal.cricjass.models.teamWithSquad.Squad
import com.shokal.cricjass.repositories.*
...
class CricketViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val context: Context
    private val _countries = MutableLiveData<List<com.shokal.cricjass.models.countries.Data>>()
    var countries: LiveData<List<com.shokal.cricjass.models.countries.Data>> = _countries

    private val _continents = MutableLiveData<List<com.shokal.cricjass.models.continents.Data>>()
    var continents: LiveData<List<com.shokal.cricjass.models.continents.Data>> = _continents

    private val _teams = MutableLiveData<List<com.shokal.cricjass.models.teams.Data>>()
    var teams: LiveData<List<com.shokal.cricjass.models.teams.Data>> = _teams

    private val _leagues = MutableLiveData<List<com.shokal.cricjass.models.leagues.Data>>()
    var leagues: LiveData<List<com.shokal.cricjass.models.leagues.Data>> = _leagues
    ...
    private var _cachedPlayerDetails = MutableLiveData<com.shokal.cricjass.models.palyers.Data>()
    val cachedPlayerDetails: LiveData<com.shokal.cricjass.models.palyers.Data>
        get() = _cachedPlayerDetails

    private var _cachedPlayerList =
        MutableLiveData<List<com.shokal.cricjass.models.playersList.Data>>()
    val cachedPlayerList: LiveData<List<com.shokal.cricjass.models.playersList.Data>>
        get() = _cachedPlayerList

    private var _cachedTeamsList =
        MutableLiveData<List<com.shokal.cricjass.models.teamRanking.Data>>()
    val cachedTeamsList: LiveData<List<com.shokal.cricjass.models.teamRanking.Data>>
    ...
    fun addAllCountry(article: List<com.shokal.cricjass.models.countries.Data>) {
    ...
    fun addAllContinents(article: List<com.shokal.cricjass.models.continents.Data>) {
        viewModelScope.launch(Dispatchers.IO) {
            cricketRepo.insertAllContinents(article)
        }
    }

    fun addAllTeams(article: List<com.shokal.cricjass.models.teams.Data>) {
        viewModelScope.launch(Dispatchers.IO) {
            cricketRepo.insertAllTeams(article)
        }
    }

    fun addAllLeague(league: List<com.shokal.cricjass.models.leagues.Data>) {
        viewModelScope.launch(Dispatchers.IO) {
